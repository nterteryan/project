<div class="section section-head clearfix">
    <div class="container padding-none clearfix">
...
<div class="section section-services clearfix">
    <div class="container">
        <h2 class="text-center">Сообщество Социальных программ МБО <br/> "Дом Блага" Представляет!</h2>
...
<div class="section-delimiter">
    <p class="text-center">Непозволяйте своим мечтам опускаться до уровня ваших <br/>доходов!</p>
    <p class="text-center">Поднимайте ваши доходы до уровня вашей мечты!</p>
</div>
<div class="section section-requirements">
    <div class="container">
        <h2 class="text-center">Что нужно делат?</h2>
        <div class="col-md-12 req-row-first padding-none clearfix">
            <div class="col-md-4 col-xs-12">
        ...
        <div class="col-md-12 padding-none section-requirements-delimiter clearfix"></div>
        <h2 class="text-center col-md-12 padding-none">Что вы получите ?</h2>
        <div class="col-md-12 padding-none req-row-sec clearfix">
            <div class="col-md-4 col-xs-12">
                <div class="section-requirements-item">
                    <p class="section-requirements-desc">
                        Оплатите вступительный взнос в расмере 100$ нашей программе  нового поколения» используются природные ресурсы, никакой химии в лечении больных
