...
class CompanyAccounts extends CActiveRecord {
     ...
     *
     * @author Narek T. 
     * @created at 28th day of July 2015
     * @return User
     */
    static function getCurrentCompany() {
        static $currentCompany;
        if (!$currentCompany instanceof CompanyAccounts) {
            $currentCompany = CompanyAccounts::model()->findByPk(1);
        }
