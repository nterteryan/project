<div class="col-md-12">
    ...
    <div class=" profile">
        ...
        <div class="">
            ...
            <div class="form-group <?php echo HtmlHelper::hasError($marketplace, 'slug'); ?>">
                <?php
                echo $form->labelEx($marketplace, 'slug', array(
                    'class' => 'control-label'
                ))
                ?>
                <?php
                echo $form->textField($marketplace, 'slug', array(
                    'class' => 'form-control'
                ));
                ?>
                <?php
                echo $form->error($marketplace, 'slug', array(
                ))
                ?>
            </div>
